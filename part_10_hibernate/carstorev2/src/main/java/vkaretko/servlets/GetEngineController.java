...
/**
 * Class GetEngineController.
 *
 * @author Karetko Victor.
 * @version 1.00.
 * @since 19.04.2017.
 */
public class GetEngineController extends HttpServlet {
    /**
     * Get list of engines from EngineDAO.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Engine> brands = EngineDAO.getInstance().getAll();
