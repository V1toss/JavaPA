...
/**
 * Class GetCarBodyController.
 *
 * @author Karetko Victor.
 * @version 1.00.
 * @since 19.04.2017.
 */
public class GetCarBodyController extends HttpServlet {
    /**
     * Get list of bodies from BodyDAO.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Body> brands = BodyDAO.getInstance().getAll();
